/**
 * Globe arc connection data — coordinates for animated arcs between global cities.
 * Extracted from Globe.tsx to keep the component focused on rendering.
 */
...
// Raw arc coordinates without colors (colors are assigned randomly at render time)
export const arcCoordinates: Omit<ArcData, "color">[] = [
...
/** Arc color palette — cyan, blue, indigo */
export const ARC_COLORS = ["#06b6d4", "#3b82f6", "#6366f1"];
